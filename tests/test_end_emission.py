#!/usr/bin/env python
#
# Regression tests for call-END emission on HBP (master/peer) systems.
#
...
# Common call parameters for MASTER-1 sourcing on TS1/TGID3100.
...
class TestGroupEnd(unittest.TestCase):
    ...
    def test_clean_call_emits_end(self):
        ...
        w.feed_group_header('MASTER-1', stream_id=sid, **_KW)
        for burst in range(6):            # full superframe, last burst vseq 5
            w.feed_group_burst('MASTER-1', burst, stream_id=sid, **_KW)
        w.feed_group_terminator('MASTER-1', stream_id=sid, **_KW)
    ...
    def test_supersession_emits_end_for_stuck_vseq2_stream(self):
        ...
        w.feed_group_header('MASTER-1', stream_id=old, **_KW)
        for burst in (0, 1, 2):           # stuck lost tail, last burst vseq 2
            w.feed_group_burst('MASTER-1', burst, stream_id=old, **_KW)
        ...
        w.feed_group_header('MASTER-1', stream_id=new, **kw2)
